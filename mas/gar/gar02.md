...
toward the East—the one called the Brute Stone, <span
id="fr_0"></span>[\*](#fn_0) the other the pointed Cubical Stone. <span
id="fr_1"></span>[†](#fn_1) In the apex of the latter, an ax is
...
<span id="fn_0"></span>[7:\*](gar02.htm#fr_0) This was also called the
...
<span id="fn_1"></span>[7:†](gar02.htm#fr_1) Now better known as the
Perfect Ashlar.
