...
<span class="smallcaps">A Procession</span> of the damned.
...
of things that pass and pass and pass, and keep on and keep on and keep
on coming.
...
fallacy that there are positive differences to judge by—That the quest
of all intellection has been for something—a fact, a basis, a
generalization, law, formula, a major premise that is positive: that the
...
<span class="contnote">\[paragraph continues\]</span> It isn't anything,
as positively distinguished from heat or magnetism or life.
Metaphysicians and theologians and biologists have tried to define life.
They have failed, because, in a positive sense, there is nothing to
...
unmodified independence—or personality or soul, as it is called in human
phenomena—
...
an ideal that is realizable only in the universal: That, if all
exclusions are false, because always are included and excluded
continuous: that if all seeming of existence perceptible to us is the
product of exclusion, there is nothing that is perceptible to us that
...
in astronomic phenomena, and chemic, biologic, psychic, sociologic: that
it is everywhere striving to localize positiveness: that to this attempt
in various fields of phenomena—which are only quasi-different—we give
...
That our whole "existence" is a striving for the positive state. The
amazing paradox of it all:
...
expressions, in all fields of phenomena, of that which we think of r as
...
with astronomy, physics, biology—For instance, if the sun should greatly
change its distance from this earth, and if human life could survive,
the familiar chemic formulas would no longer work out: a new science of
...
of all ideals, and that it is the attempt to be, or to achieve, locally,
that which is realizable only universally. In our experience there is
only intermediateness to harmony and discord. Harmony is that besides
...
positive sense, or is to be intermediate to Equilibrium and
Inequilibrium.
...
outside forces—or by the excluded that are continuous with the included:
...
That it has attempted to be real, true, final, complete, absolute: That,
if the seeming of being, here, in our quasi-state, is the product of
...
who accept Continuity, or the merging away of all phenomena into other
...
conceived of as a whole, and

<span id="page_13">p. 13</span>

that there is no way of conceiving what it might be equal and opposite
to—
...
positiveness and negativeness or realness and unrealness. Like
purgatory, I think.
...
and that which is not partly something else: that which
