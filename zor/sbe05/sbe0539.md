...
[Index](index)  [Previous](sbe0538)  [Next](sbe0540) 
...
### CHAPTER XXX <span id="fr_681"></span>[6](#fn_676).
...
earth <span id="fr_682"></span>[7](#fn_677), first fed upon water, then
...
bread, till when <span id="fr_683"></span>[1](#fn_678) they shall die
they always feed upon water. 2. So, likewise, in the millennium of
Hûshê*d*ar-mâh <span id="fr_684"></span>[2](#fn_679), the strength of
...
Sôshyans <span id="fr_685"></span>[3](#fn_680) comes they remain without
food, *and* do not die.
...
id="fr_689"></span>[1](#fn_684) of various kinds was created in plants;
when by me fire was created in plants *and* other things <span
id="fr_690"></span>[2](#fn_685) without combustion; when *by me* a son
was created *and* fashioned <span id="fr_691"></span>[3](#fn_686) in the
...
id="fr_692"></span>[4](#fn_687) *it is* an assistance to me in the
resurrection that they exist, *but* when they were formed it was not
*forming* the future out of the past <span
id="fr_693"></span>[5](#fn_688). 6. Observe that when that which was not
...
years *of* Sôshyans <span id="fr_694"></span>[1](#fn_689) they prepare
...
single class <span id="fr_695"></span>[2](#fn_690). 9. Of the light
...
id="fr_696"></span>[3](#fn_691) where all mankind will stand at this
...
assembly <span id="fr_697"></span>[1](#fn_692).
...
in heaven <span id="fr_698"></span>[2](#fn_693). 14. As it says that, on
...
Afterwards, the fire and halo <span id="fr_702"></span>[4](#fn_697) melt
...
it <span id="fr_703"></span>[1](#fn_698) been these many years, and what
...
Hadhayôs <span id="fr_704"></span>[2](#fn_699) in that Ya*z*i*s*n; from
the fat of that ox and the white Hôm <span
id="fr_705"></span>[3](#fn_700) they prepare Hûsh, *and* give *it* to
...
ordered no Gêtî-kharî*d* <span id="fr_706"></span>[1](#fn_701), and has
...
id="fr_707"></span>[2](#fn_702) provide him the use of his clothing.

<span id="page_128">p. 128</span>

29\. Afterwards, Aûharmazd seizes on <span
id="fr_708"></span>[1](#fn_703) the evil spirit, Vohûman *on*
Akôman <span id="fr_709"></span>[2](#fn_704), Ashavahi*s*t *on*
Andar <span id="fr_710"></span>[3](#fn_705), Shatvaîrô *on* Sâvar,
Spendarma*d* *on* Tarômat who is Nâûnghas <span
id="fr_711"></span>[4](#fn_706), Horvada*d* *and* Amerôda*d* *on*
Tâîrê*v* *and* Zâîrî*k* <span id="fr_712"></span>[5](#fn_707),
true-speaking *on* what is evil-speaking, Srôsh <span
id="fr_713"></span>[6](#fn_708) *on* Aeshm <span
id="fr_714"></span>[7](#fn_709) 30. Then two fiends remain at large,
Aharman <span id="fr_715"></span>[8](#fn_710) and Â*z* <span
id="fr_716"></span>[9](#fn_711); Aûharmazd comes to the world, himself
the Zôta and Srôsh the Râspî <span id="fr_717"></span>[10](#fn_712), and
holds the Kûstî in *his* hand;

<span id="page_129">p. 129</span>

defeated by the Kûstî <span id="fr_718"></span>[1](#fn_713) formula the
resources of the evil spirit and Â*z* act most impotently, *and* by the
passage through which he rushed into the sky <span
id="fr_719"></span>[2](#fn_714) he runs back to gloom *and* darkness.
31. Gô*k*îhar <span id="fr_720"></span>[3](#fn_715) burns the serpent
(mâr) <span id="fr_721"></span>[4](#fn_716) in the melted metal, *and*
...
vault <span id="fr_722"></span>[5](#fn_717) into which the evil spirit
fled, in that metal; he brings the land of hell back for the enlargement
of the world <span id="fr_723"></span>[6](#fn_718); the renovation
...
id="fr_724"></span>[7](#fn_719), slopeless plain <span
id="fr_725"></span>[8](#fn_720); even the mountain <span
id="fr_726"></span>[9](#fn_721),
...
<span id="fn_676"></span>[120:6](sbe0539.htm#fr_681) This chapter is
found in all MSS., and has been numbered XXXI by former translators.

<span id="fn_677"></span>[120:7](sbe0539.htm#fr_682) See Chaps. XV,
2-16, XXXIV, 3.

<span id="fn_678"></span>[121:1](sbe0539.htm#fr_683) Reading amat,
'when,' instead of mûn, 'which' (see the note on Chap. 1, 7).

<span id="fn_679"></span>[121:2](sbe0539.htm#fr_684) Written
Khûrshê*d*ar-mâh, or Khûrshê*d*-mâh, in the Bundahi*s*; see Chap. XXXII,
8, and Bahman Yt. III, 52, 53.

<span id="fn_680"></span>[121:3](sbe0539.htm#fr_685) See Chaps. XI, 6, X
XXII, 8, Bahman Yt. III, 62.

<span id="fn_681"></span>[121:4](sbe0539.htm#fr_686) Compare (Vend. V,
26) 'the water carries *him* up, the water carries *him* down, the water
casts *him* away.'

<span id="fn_682"></span>[121:5](sbe0539.htm#fr_687) Compare Mkh. IX, 7.

<span id="fn_683"></span>[121:6](sbe0539.htm#fr_688) All MSS. have min,
...
<span id="fn_684"></span>[122:1](sbe0539.htm#fr_689) Former translators
all read rag, 'vein, pore;' but it probably stands for rang, 'colour,
dye,' as in Chap. XXVII, 5, 18.

<span id="fn_685"></span>[122:2](sbe0539.htm#fr_690) See Chap. XVII, 1,
2.

<span id="fn_686"></span>[122:3](sbe0539.htm#fr_691) Pâz. srahtîd is
evidently a misreading of Pahl. srî*s*tî*d*, 'formed, shaped.'
Windischmann compares Fravardîn Yt. 11, 22, 28.

<span id="fn_687"></span>[122:4](sbe0539.htm#fr_692) Here *k*îm is the
Pâzand of Huz. mamanam, 'for to me;' being a different word from the
interrogative *k*îm, 'why?' of the next §.

<span id="fn_688"></span>[122:5](sbe0539.htm#fr_693) Literally, '*what*
becomes out of *what* was.'

<span id="fn_689"></span>[123:1](sbe0539.htm#fr_694) K20 omits
'Sôshyans.'

<span id="fn_690"></span>[123:2](sbe0539.htm#fr_695) The phrase is
...
<span id="fn_691"></span>[123:3](sbe0539.htm#fr_696) Windischmann
...
