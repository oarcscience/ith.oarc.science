...
[Index](index)  [Previous](sbe0527)  [Next](sbe0529) 
...
id="fr_345"></span>[4](#fn_343) they say, that it stands amid the
wide-formed ocean, and its feet are three, eyes six, mouths <span
id="fr_346"></span>[5](#fn_344) nine, ears two, and horn
...
id="fr_347"></span>[1](#fn_345); with the sharpness of those six eyes it
...
Mount Alvand <span id="fr_348"></span>[2](#fn_346). 4. Each one of the
...
*and* each pastern <span id="fr_349"></span>[3](#fn_347) is so great in
...
horns <span id="fr_350"></span>[4](#fn_348) have grown upon it, some
befitting <span id="fr_351"></span>[5](#fn_349) a camel, some befitting
...
id="fr_352"></span>[1](#fn_350) will tremble (shîvanê*d*). 9. When it
...
11\. Tî*s*tar seizes the water <span id="fr_353"></span>[2](#fn_351)
...
13\. Of the ox Hadhayô*s* <span id="fr_354"></span>[3](#fn_352), which
they call Sarsaok <span id="fr_355"></span>[4](#fn_353), it says, that
...
id="fr_356"></span>[1](#fn_354), who has constructed the most defences
around this earth, until the renovation *of the universe* is requisite.

15\. Regarding the bird *K*âmrô*s* <span id="fr_357"></span>[2](#fn_355)
...
id="fr_358"></span>[3](#fn_356), by going to bring damage (zîyân) on the
Iranian districts, and to effect the devastation of the world; then the
angel Bûr*g* <span id="fr_359"></span>[4](#fn_357), *having* come up
from the low country of Lake Arag <span id="fr_360"></span>[5](#fn_358),
...
16\. Regarding Kar*s*ipt <span id="fr_361"></span>[6](#fn_359) they say,
...
18\. The griffon bird <span id="fr_362"></span>[1](#fn_360), which is a
bat, is noticed (kar*d*) twice in another chapter (babâ).

19\. Regarding the bird Ashôzu*s*t <span
id="fr_363"></span>[2](#fn_361), which is the bird Zobara <span
id="fr_364"></span>[3](#fn_362)-vahman *and* also the bird *S*ôk <span
id="fr_365"></span>[4](#fn_363), they say that it has given an Avesta
...
id="fr_366"></span>[5](#fn_364) 22. This, too, it says, that of all
precious <span id="fr_367"></span>[6](#fn_365) birds the crow (valâgh)
...
Kahrkâs <span id="fr_368"></span>[1](#fn_366), dwelling in decay, which
is the vulture, is created for devouring dead matter (nasâî); so also
are the crow (valâk) <span id="fr_369"></span>[2](#fn_367) and the
mountain kite.
...
id="fr_370"></span>[3](#fn_368) to ravenous intestinal worms
(ka*d*ûk-dânak gar*z*ak). 28. The hedgehog is created in opposition to
the ant which carries off grain <span id="fr_371"></span>[4](#fn_369),
...
a hollow track <span id="fr_372"></span>[1](#fn_370); when the hedgehog
...
id="fr_373"></span>[2](#fn_371), in destroying the fiends, are the cock
and the dog. 34. This, too, it says, that it would not have *been*
managed if I had not created the shepherd's dog, which is the
Pasu*s*-haurva <span id="fr_374"></span>[3](#fn_372), *and* the house
watchdog, the Vi*s*-haurva <span id="fr_375"></span>[3](#fn_372); for it
...
id="fr_376"></span>[1](#fn_373); and its flesh and fat are remedies for
driving away decay and pain from men <span
id="fr_377"></span>[2](#fn_374).
...
dispositions (khûk) <span id="fr_378"></span>[3](#fn_375) are created in
...
<span id="fn_343"></span>[67:4](sbe0528.htm#fr_345) The Av. khara,
...
<span id="fn_344"></span>[67:5](sbe0528.htm#fr_346) This is the
...
<span id="fn_345"></span>[68:1](sbe0528.htm#fr_347) The hump is probably
supposed to be over the shoulders, as in the Indian ox, and not like
that of the camel.

<span id="fn_346"></span>[68:2](sbe0528.htm#fr_348) Near Hamadân, rising
...
<span id="fn_347"></span>[68:3](sbe0528.htm#fr_349) Literally, 'the
