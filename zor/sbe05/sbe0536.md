...
[Index](index)  [Previous](sbe0535)  [Next](sbe0537) 
...
thorny <span id="fr_539"></span>[1](#fn_534), for antagonism mingled
...
id="fr_540"></span>[2](#fn_535), that is poisonous, for men when they
eat *it* die.
...
primeval ox <span id="fr_541"></span>[3](#fn_536), ten thousand <span
id="fr_542"></span>[4](#fn_537) species among the species of principal
...
id="fr_543"></span>[1](#fn_538), the many-seeded, *which* has grown in
...
id="fr_544"></span>[2](#fn_539) strips that tree *and* mingles all the
...
Arêdvîvsûr <span id="fr_545"></span>[3](#fn_540); every one who eats
*it* becomes immortal, and they call it the Gôkar*d* <span
id="fr_546"></span>[4](#fn_541) tree, as it is said that Hôm is
expelling death <span id="fr_547"></span>[5](#fn_542); also in the
renovation *of the universe* they prepare its immortality
therefrom <span id="fr_548"></span>[6](#fn_543); *and* it is the chief
of plants <span id="fr_549"></span>[7](#fn_544).
...
id="fr_550"></span>[1](#fn_545) oil, dyes, *and* clothing. 6. I *will*
...
id="fr_553"></span>[4](#fn_548) of pulse, vetches, *and* others of this
...
eating of bread, as torn shoots <span id="fr_554"></span>[1](#fn_549) of
the coriander, water-cress (kakî*g*), the leek, *and* others of this
genus, they call salad (têrak) <span id="fr_555"></span>[2](#fn_550).
16. Whatever is like spinning <span id="fr_556"></span>[3](#fn_551)
cotton, *and* others of this genus, they call clothing *plants*
(*g*âmak). 17. Whatever lentil <span id="fr_557"></span>[4](#fn_552) is
greasy, as sesame, dûshdâng, hemp, zandak <span
id="fr_558"></span>[5](#fn_553), and others of this genus, they call an
...
id="fr_559"></span>[6](#fn_554), or wood

<span id="page_103">p. 103</span>

is scented, as frankincense <span id="fr_560"></span>[1](#fn_555),
varâ*s*t <span id="fr_561"></span>[2](#fn_556), kust, sandalwood,
cardamom <span id="fr_562"></span>[3](#fn_557), camphor, orange-scented
mint, *and* others of this genus, they call a scent (bôd). 20. Whatever
stickiness comes out from plants <span id="fr_563"></span>[4](#fn_558)
...
cocoanut <span id="fr_565"></span>[6](#fn_560), the filbert <span
id="fr_566"></span>[7](#fn_561), the chesnut <span
id="fr_567"></span>[8](#fn_562), the pistachio nut, the vargân, *and*
whatever else of this description are very remarkable.

24 <span id="fr_568"></span>[9](#fn_563). This, too, it says, that every
single flower is appropriate to an angel (ameshôspend) <span
id="fr_569"></span>[10](#fn_564), as the

<span id="page_104">p. 104</span>

white <span id="fr_570"></span>[1](#fn_565) jasmine (saman) is for
Vohûman, the myrtle *and* jasmine (yâsmin) are Aûharmazd's own, the
mouse-ear (or sweet marjoram) is Ashavahi*s*t's <span
id="fr_571"></span>[2](#fn_566) own, the basil-royal is Shatvaîrô's own,
...
id="fr_572"></span>[3](#fn_567) (âdargun), the water-lily is Âvân's, the
white marv is Khtûrshê*d*'s, the ranges <span
id="fr_573"></span>[4](#fn_568) is Mâh's, the violet is Tîr's, the
mêren <span id="fr_574"></span>[5](#fn_569) is Gô*s*'s, the kârda is
...
id="fr_575"></span>[6](#fn_570), the trigonella is Dîn-pavan-Dîn's, the
hundred-petalled rose is Dîn's, all kinds of wild flowers (vahâr) are
Ar*d*'s <span id="fr_576"></span>[7](#fn_571), Â*s*tâ*d* *has* all the
white Hôm <span id="fr_577"></span>[8](#fn_572), the bread-baker's basil
is Asmân's, Zamyâ*d* *has* the crocus, Mâraspend *has the flower* <span
id="fr_578"></span>[9](#fn_573) of Ardashîr,

<span id="page_105">p. 105</span>

<span class="contnote">\[paragraph continues\]</span> Anîrân *has* this
Hôm of the angel Hôm <span id="fr_579"></span>[1](#fn_574), of three
kinds.
...
the fire <span id="fr_580"></span>[2](#fn_575); Most of all it is the
...
<span id="fn_534"></span>[99:1](sbe0536.htm#fr_539) M6 has 'poisonous,'
but is evidently copied from an original almost illegible in some
places.

<span id="fn_535"></span>[99:2](sbe0536.htm#fr_540) Perhaps 'hemp the
...
<span id="fn_536"></span>[99:3](sbe0536.htm#fr_541) See Chap. XIV, 1.

<span id="fn_537"></span>[99:4](sbe0536.htm#fr_542) M6 has 'a thousand,'
but marks an omission. See Chap. IX. 4.

<span id="fn_538"></span>[100:1](sbe0536.htm#fr_543) See Chaps. IX, 5,
XVIII, 9, XXIX, 5.

<span id="fn_539"></span>[100:2](sbe0536.htm#fr_544) The apparently
...
<span id="fn_540"></span>[100:3](sbe0536.htm#fr_545) See Chaps. XII, 5,
XIII, 3-5.

<span id="fn_541"></span>[100:4](sbe0536.htm#fr_546) Here written Gôkarn
in all MSS. See Chaps. IX, 6, XVIII, I, 2.

<span id="fn_542"></span>[100:5](sbe0536.htm#fr_547) That is, in Yas.
IX, where Haoma is entitled dûraosha.

<span id="fn_543"></span>[100:6](sbe0536.htm#fr_548) See Chap. XXIV, 27.

<span id="fn_544"></span>[100:7](sbe0536.htm#fr_549) See Chap. XXIV, 18.

<span id="fn_545"></span>[101:1](sbe0536.htm#fr_550) Comparing this list
...
<span id="fn_546"></span>[101:2](sbe0536.htm#fr_551) The kûnâr (see
Chap. XV, 13).

<span id="fn_547"></span>[101:3](sbe0536.htm#fr_552) The Pâz. pêhani
(which is omitted in K20) is evidently a misreading of Pahl. pashang, 'a
hoe-like spade.'

<span id="fn_548"></span>[101:4](sbe0536.htm#fr_553) M6 adds Pâz. gavina
(Pahl. gûnak) to gvî*d* gvî*d* mungân, without altering the meaning
materially.

<span id="fn_549"></span>[102:1](sbe0536.htm#fr_554) Reading stâk
darî*d*; Justi has 'baked shoots;' Anquetil has 'the three following;'
M6 has stâk va karafs, 'shoots and parsley.'

<span id="fn_550"></span>[102:2](sbe0536.htm#fr_555) Or târak in § 5,
Pers. tarah.

<span id="fn_551"></span>[102:3](sbe0536.htm#fr_556) Reading Huz.
...
<span id="fn_552"></span>[102:4](sbe0536.htm#fr_557) Reading ma*k*ag;
Anquetil, Windischmann, and Justi read mazg, 'marrow,' but this is
usually written otherwise.

<span id="fn_553"></span>[102:5](sbe0536.htm#fr_558) Perhaps for zêtô,
'olive,' as Anquetil supposes, and Justi assumes.

<span id="fn_554"></span>[102:6](sbe0536.htm#fr_559) Reading tûf
(compare Pers. tuf, 'saliva').

<span id="fn_555"></span>[103:1](sbe0536.htm#fr_560) Pâz. kendri for
Pahl. kundur probably.

<span id="fn_556"></span>[103:2](sbe0536.htm#fr_561) Justi compares
Pers. bargha*s*t.

<span id="fn_557"></span>[103:3](sbe0536.htm#fr_562) Pâz. kâkura may be
equivalent to Pers. qaqulah, 'cardamoms,' or to Pers. kâkul or kâkûl,
'marjoram.'

<span id="fn_558"></span>[103:4](sbe0536.htm#fr_563) K20 omits a line,
from here to the word 'either.'

<span id="fn_559"></span>[103:5](sbe0536.htm#fr_564) The line which
contained this sentence is torn off in K20.

<span id="fn_560"></span>[103:6](sbe0536.htm#fr_565) Pâz. anârsar is a
misreading of Pahl. anârgîl (Pers. nârgîl, 'cocoa-nut').

<span id="fn_561"></span>[103:7](sbe0536.htm#fr_566) Pâz. pendak, a
misreading of Pahl. funduk.

<span id="fn_562"></span>[103:8](sbe0536.htm#fr_567) Pâz. shahbrôd, a
misreading of Pahl. shahbalût; omitted in M6.

<span id="fn_563"></span>[103:9](sbe0536.htm#fr_568) M6 begins a new
chapter here.

<span id="fn_564"></span>[103:10](sbe0536.htm#fr_569) These are the
...
<span id="fn_565"></span>[104:1](sbe0536.htm#fr_570) M6 has 'yellow.'

<span id="fn_566"></span>[104:2](sbe0536.htm#fr_571) Synonymous with the
Ar*d*avahi*s*t of Chap. I, 26.

<span id="fn_567"></span>[104:3](sbe0536.htm#fr_572) Anquetil,
Windischmann, and Justi have 'the poppy.'

<span id="fn_568"></span>[104:4](sbe0536.htm#fr_573) M6 has Pâz. lg as
...
<span id="fn_569"></span>[104:5](sbe0536.htm#fr_574) M6 has Pâz. mênr;
Anquetil has 'vine blossom,' and is followed by Windischmann and Justi,
but the word is very uncertain.

<span id="fn_570"></span>[104:6](sbe0536.htm#fr_575) The remainder of
this chapter is lost from K20.

<span id="fn_571"></span>[104:7](sbe0536.htm#fr_576) This female angel
is also called Arshi*s*ang (see Chap. XXII, 4).

<span id="fn_572"></span>[104:8](sbe0536.htm#fr_577) See § 4.

<span id="fn_573"></span>[104:9](sbe0536.htm#fr_578) M6 leaves a blank
space for the name of the flower; perhaps it is the marv-i Ardashîrân.

<span id="fn_574"></span>[105:1](sbe0536.htm#fr_579) Reading, in
Pahlavi, Hôm yêdatô aê hôm.

<span id="fn_575"></span>[105:2](sbe0536.htm#fr_580) See Chap. XXI, 1.
