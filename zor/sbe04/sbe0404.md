...
[Index](index)  [Previous](sbe0403)  [Next](sbe0405) 
...
id="fr_34"></span>[1](#fn_34), is divided, in its usual form, into two
parts.
...
entirety, the Vendîdâd <span id="fr_35"></span>[1](#fn_35).

This tradition is very old, and may be traced back from the present
period even to Sassanian times <span id="fr_36"></span>[2](#fn_36). It
...
origin <span id="fr_37"></span>[3](#fn_37), also comprises many
...
id="fr_38"></span>[1](#fn_38): 'Now that we have recognised the law of
the world here below, they shall not allow the infidelity of any one
whatever <span id="fr_39"></span>[2](#fn_39), as I shall strive that it
may be so <span id="fr_40"></span>[3](#fn_40).'
...
id="fr_41"></span>[4](#fn_41). Most Parsi and Muhammedan writers agree
...
establishment <span id="fr_42"></span>[5](#fn_42). Therefore it seems
...
Vologeses <span id="fr_43"></span>[1](#fn_43), the contemporary of Nero.
...
Magian (Magus) <span id="fr_44"></span>[2](#fn_44); and by this term we
must not understand a magician <span id="fr_45"></span>[3](#fn_45), but
a priest, and one of the Zoroastrian religion. That he was a priest
appears from Tacitus’ testimony <span id="fr_46"></span>[4](#fn_46);
...
along the coasts, <span id="fr_47"></span>[5](#fn_47), because the Magi
were forbidden to defile the sea <span id="fr_48"></span>[6](#fn_48).
...
id="fr_50"></span>[2](#fn_50). It can, therefore, be fairly admitted
...
Bâmdâd <span id="fr_51"></span>[1](#fn_51), who was put to death in the
...
period <span id="fr_53"></span>[1](#fn_53), the Mainyô-i-Khard:
...
Ameshâspeñds <span id="fr_54"></span>[1](#fn_54).'
...
against the ungodly Ashemaogha <span id="fr_55"></span>[2](#fn_55) who
does not eat <span id="fr_56"></span>[3](#fn_56).'
...
Christians in Armenia <span id="fr_57"></span>[4](#fn_57). But however
...
doctrines than with the Christian <span id="fr_58"></span>[5](#fn_58).
...
id="fr_59"></span>[6](#fn_59). We find, therefore, in this passage, an
...
id="fr_61"></span>[1](#fn_60). Yet there are a few passages which make
...
id="fr_62"></span>[2](#fn_61); whether these hymns were the same as the
...
credited when he says that Hermippus <span id="fr_63"></span>[3](#fn_62)
had given an analysis of the books of Zoroaster, which are said to have
amounted to 2,000,000 lines <span id="fr_64"></span>[4](#fn_63). For
...
in Theopompos <span id="fr_65"></span>[1](#fn_64) with the data of the
...
mythology <span id="fr_66"></span>[2](#fn_65). Therefore there is
...
Greek invasion <span id="fr_67"></span>[3](#fn_66).
...
id="fr_68"></span>[1](#fn_67). But it is never safe to draw wide
...
agrees with the character of Ormazd <span id="fr_69"></span>[2](#fn_68).
...
id="fr_70"></span>[1](#fn_69). It appears, it is true, from the words of
Herodotus, that it was only a custom peculiar to the Magi <span
id="fr_71"></span>[2](#fn_70); but is shows, at least, that the belief
...
id="fr_72"></span>[3](#fn_71); we know that under the Sassanians a prime
minister, Seoses, paid with his life for an infraction of that law <span
id="fr_73"></span>[4](#fn_72). Corpses were to be laid down on the
...
id="fr_74"></span>[5](#fn_73). Now under the Achæmenian rule, not only
...
having coated them with wax <span id="fr_75"></span>[6](#fn_74). But
...
id="fr_76"></span>[7](#fn_75). There were
...
Marcellinus <span id="fr_77"></span>[1](#fn_76) (fourth cent. A.D.)
...
spread over the land <span id="fr_78"></span>[2](#fn_77) . Lastly, we
...
Minochihr <span id="fr_79"></span>[1](#fn_78), and even nowadays the
...
a Dastur can become one <span id="fr_80"></span>[2](#fn_79).
...
id="fr_81"></span>[3](#fn_80); and there is in the Avesta itself (Yasna
...
id="fr_85"></span>[1](#fn_84): 'In Shîz is the fire temple of Azerekhsh,
...
prophet <span id="fr_86"></span>[2](#fn_85).'
...
id="fr_87"></span>[3](#fn_86). Although this detail referred originally
...
the Aras (Vanguhi Dâitya) <span id="fr_88"></span>[4](#fn_87), this
...
the river Dare*g*a <span id="fr_89"></span>[5](#fn_88), a name which
...
id="fr_93"></span>[4](#fn_92); yet whenever he had to invoke the favour
...
beard by heaven <span id="fr_94"></span>[5](#fn_93). When and how the
religious hegemony of Media arose we cannot say: it is but natural that
Media <span id="fr_95"></span>[6](#fn_94),
...
written by themselves <span id="fr_96"></span>[1](#fn_95); which is
...
functions <span id="fr_97"></span>[2](#fn_96); but the Magi themselves
...
of the Magi <span id="fr_98"></span>[1](#fn_97).' The name, it is true,
...
worship <span id="fr_100"></span>[1](#fn_99): the Magi drew from that
...
Darius <span id="fr_101"></span>[1](#fn_100). It seems to have resumed
...
id="fr_102"></span>[2](#fn_101). New progress marked the reign of
...
id="fr_103"></span>[3](#fn_102). But the real victory was not won till
...
id="fr_104"></span>[4](#fn_103), and the Magian
...
id="fr_105"></span>[1](#fn_104), and Magism, by enforcing its
...
of its fall <span id="fr_106"></span>[2](#fn_105).

------------------------------------------------------------------------

### Footnotes

<span id="fn_34"></span>[xxx:1](sbe0404.htm#fr_34) A very improper
...
<span id="fn_35"></span>[xxxii:1](sbe0404.htm#fr_35) Ravâet ap.
...
<span id="fn_36"></span>[xxxii:2](sbe0404.htm#fr_36) J. Darmesteter, La
légende d’Alexandre chez les Parses.

<span id="fn_37"></span>[xxxii:3](sbe0404.htm#fr_37) We find in it a
...
<span id="fn_38"></span>[xxxiii:1](sbe0404.htm#fr_38) Gvê*t* rastakân.
We are indebted to Mr. West for the right translation this word.

<span id="fn_39"></span>[xxxiii:2](sbe0404.htm#fr_39) Thus translated by
West (Glossary of the Book of Ardâ Vîrâf, p. 27).

<span id="fn_40"></span>[xxxiii:3](sbe0404.htm#fr_40) Haug, Essay on
Pahlavi p. 145 seq., 149 seq.

<span id="fn_41"></span>[xxxiii:4](sbe0404.htm#fr_41) Spiegel, Eranische
Alterthumskunde III, 782, n. 1.

<span id="fn_42"></span>[xxxiii:5](sbe0404.htm#fr_42) S. de Sacy,
Mémoires sur quelques antiquités de la Perse. Cf. Masudi, 125. II, 125.

<span id="fn_43"></span>[xxxiv:1](sbe0404.htm#fr_43) Perhaps five (see
de Longpérier, Mémoire sur la Numismatique des Arsacides, p. 111).

<span id="fn_44"></span>[xxxiv:2](sbe0404.htm#fr_44) 'Magus ad eum
Tiridates venerat' (Pliny, Nat. Hist. XXX, 6).

<span id="fn_45"></span>[xxxiv:3](sbe0404.htm#fr_45) Pliny very often
...
<span id="fn_46"></span>[xxxiv:4](sbe0404.htm#fr_46) 'Nec recusaturum
<span id="fn_77"></span>[xlvi:2](sbe0404.htm#fr_78) Τὸ τῶν Μάγων φῦλον
(XV, 14).

<span id="fn_78"></span>[xlvii:1](sbe0404.htm#fr_79) Bundahi*s* 79, 13.

<span id="fn_79"></span>[xlvii:2](sbe0404.htm#fr_80) Dosabhoy Framjee,
The Parsees, &c. p. 277.

<span id="fn_80"></span>[xlvii:3](sbe0404.htm#fr_81) 'Ragha of the three
...
<span id="fn_81"></span>[xlviii:1](sbe0404.htm#fr_82) Or possibly, 'in
the Zarathu*s*trian Ragha.'

<span id="fn_82"></span>[xlviii:2](sbe0404.htm#fr_83) The Commentary has
...
afar to bring holiness to countries;' cf. infra, [p. lii](#page_lii),
note [1](#fn_97), and Farg. XIII, 22.

<span id="fn_83"></span>[xlviii:3](sbe0404.htm#fr_84) Dictionnaire
...
<span id="fn_84"></span>[xlix:1](sbe0404.htm#fr_85) The Persian Gazn,
...
<span id="fn_85"></span>[xlix:2](sbe0404.htm#fr_86) Kazwini, and
Rawlinson, l.c. p. 69.

<span id="fn_86"></span>[xlix:3](sbe0404.htm#fr_87) Bund. 79, 12.

<span id="fn_87"></span>[xlix:4](sbe0404.htm#fr_88) See Farg. I, p. 3.

<span id="fn_88"></span>[xlix:5](sbe0404.htm#fr_89) See Farg. XIX, 4,
11.

<span id="fn_89"></span>[l:1](sbe0404.htm#fr_90) This would be a
principle of classification which unfortunately applies only to a small
part of the Avesta.

<span id="fn_90"></span>[l:2](sbe0404.htm#fr_91) Still, if we follow the
...
<span id="fn_91"></span>[l:3](sbe0404.htm#fr_92) The Pahlavi names of
the cardinal points show that Media was the centre of orientation in
Magian geography (Garrez, Journal Asiatique, 1869, II).

<span id="fn_92"></span>[l:4](sbe0404.htm#fr_93) Magophonia (Herod. III,
79).

<span id="fn_93"></span>[l:5](sbe0404.htm#fr_94) Ὡς ἀυτοὺς μόνους
ἀκουομένουσ (Diog. Laert. Prooem.); cf. Herod. I, 132 Ammian. l. l.

<span id="fn_94"></span>[l:6](sbe0404.htm#fr_95) An echo of the old
...
<span id="fn_95"></span>[li:1](sbe0404.htm#fr_96) In their own language,
...
<span id="fn_96"></span>[li:2](sbe0404.htm#fr_97) The Pahlavi has 'one
...
<span id="fn_97"></span>[lii:1](sbe0404.htm#fr_98) A further echo of the
...
<span id="fn_98"></span>[lii:2](sbe0404.htm#fr_99) If the interpretation
...
<span id="fn_99"></span>[liv:1](sbe0404.htm#fr_100) Cf. V, 8.

<span id="fn_100"></span>[lv:1](sbe0404.htm#fr_101) Darius rebuilt the
...
<span id="fn_101"></span>[lv:2](sbe0404.htm#fr_102) Pliny, Hist. Nat.,
XXX, I, 8.

<span id="fn_102"></span>[lv:3](sbe0404.htm#fr_103) Cf. Westergaard,
...
<span id="fn_103"></span>[lv:4](sbe0404.htm#fr_104) Agathias II, 26.

<span id="fn_104"></span>[lvi:1](sbe0404.htm#fr_105) De Gobineau,
Histoire des Perses, II, 632 seq.

<span id="fn_105"></span>[lvi:2](sbe0404.htm#fr_106) We ought to discuss
...
[Next: Chapter IV. The Origin of the Avesta Religion](sbe0405)
