[Sacred-Texts](../../index) [Classics](../index) [Index](index) [Previous](af09) [Next](af11.md)

------------------------------------------------------------------------

## ORPHIC FRAGMENTS.

### FROM ORPHEUS.<span id="fr_1"></span>[1](#note_1.md)
...
He begot our race (the birds),<span id="fr_2"></span>[2](#note_2.md) and
...
### FROM ORPHEUS.<span id="fr_3"></span>[3](#note_3.md)
...
id="fr_4"></span>[4](#note_4.md) as of all the creation which existed and
...
### FROM THE ANCIENT THEOLOGISTS.<span id="fr_5"></span>[5](#note_5.md)
...
<span id="note_1"></span>[1](#fr_1.md) Eusebius and Proclus omit the fifth
and sixth verses between the parentheses. Aristotle places the fourth
before the third.

<span id="note_2"></span>[2](#fr_2.md) This cosmogony is delivered by the
Birds in the comedy so called, and in this line they claim the priority
of birth before the gods as well as men.

<span id="note_3"></span>[3](#fr_3.md) I have given this fragment from
...
<span id="note_4"></span>[4](#fr_4.md) Omitted by Ced.

<span id="note_5"></span>[5](#fr_5.md) This extract from a MS. of Syrian is
