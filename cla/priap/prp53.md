...
Bacchus is wont to be content with a modest cluster from the vine, even
when the deep vats can barely contain the must. And when the spacious
threshing floors are insufficient for the rich harvest, in Ceres' locks
a single garland is wreathed. Do thou also, less potent deity, guided by
their greater example, although our offering be only a few apples, take
it in good part.
