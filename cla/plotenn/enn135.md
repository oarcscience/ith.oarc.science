...
[Index](index)  [Previous](enn134)  [Next](enn136.md) 
...
from the other: that which defines Matter must be kept quite apart from
...
included in the concept of heat- if Matter is Privation in the way in
which fire is heat, then the Privation is a form under which Matter
appears but there remains a base distinct from the Privation and this
base must be the Matter. Here, too, they are not one thing.

Perhaps the identity in substance with differentiation in reason will be
defended on the ground that Privation does not point to something
...
still makes Privation and Matter two in reason though one in substratum.
