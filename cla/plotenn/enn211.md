...
[Index](index)  [Previous](enn210)  [Next](enn212.md) 
...
compound living thing: to observe, therefore, its content is to be aware
...
total of their history at once overruled by the Reason-Principle and yet
...
to make a perfect discrimination setting on the one side Providence with
all that happens under Providence and on the other side what the
...
the interplay of members of one living being; each in its own place and
way moves as its own nature demands; to every organ its grade and task,
and to every grade and task its effective organ.

------------------------------------------------------------------------

[Next: Section 7](enn212.md)
