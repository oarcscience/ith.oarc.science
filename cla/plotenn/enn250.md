...
[Index](index)  [Previous](enn249)  [Next](enn251.md) 
...
conflict with their opponent principles, not with their substrata- which
it would be foolish to confuse with the entrant forms- Heat \[the
Principle\] annuls Cold, and Blackness annuls Whiteness; or, the
...
all such dissolution of constituent parts, in the new combinations, in
all variation from the original structure, the affection is bodily, the
Soul or Mind having no more than an accompanying knowledge of the more
...
But if this Mother does give anything to the offspring it does so not in
its quality as Matter but as being an Ideal-Form; for only the Idea is
...
Matter, eternally unmoved, is indicated by the eunuchs surrounding it in
its representation as the All-Mother.
...
intention of suggesting a complete parallel with motherhood to those not
satisfied with a surface impression but needing a precisely true
...
Matter as approached by what is neither female nor effectively male, but
castrated of that impregnating power which belongs only to the
unchangeably masculine.

------------------------------------------------------------------------

[Next: SEVENTH TRACTATE](enn251.md)
