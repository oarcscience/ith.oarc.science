...
[Index](index)  [Previous](enn132)  [Next](enn134) 
...
undistinguishable from the Matter\] or not Ideal-Forms \[apt to body\]
but Reason-Principles \[utterly removed\] whose sphere could only be
Soul; at this, there would be no such thing as body \[i.e., instead of
...
the constituents comes bringing its own Matter with it, there is no need
of any other base. No doubt there must be a container, as it were a
place, to receive what is to enter, but Matter and even body precede
...
for it is no sound: it is no flavour or savour for nostrils or palate:
can it, perhaps, be known to touch? No: for neither is it corporeal; and
touch deals with body, which is known by being solid, fragile, soft,
hard, moist, dry- all properties utterly lacking in Matter.
