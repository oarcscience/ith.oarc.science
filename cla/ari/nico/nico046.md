...
between the two unequals involved in either case. And this is the equal;
for in any kind of action in which there's a more and a less there is
also what is equal. If, then, the unjust is unequal, just is equal, as
all men suppose it to be, even apart from argument. And since the equal
is intermediate, the just will be an intermediate. Now equality implies
at least two things. The just, then, must be both intermediate and equal
