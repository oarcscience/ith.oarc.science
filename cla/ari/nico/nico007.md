...
#### The good must be something final and self-sufficient. Definition of happiness reached by considering the characteristic function of man.
...
which follows or implies a rational principle, and if we say 'so-and-so'
and 'a good so-and-so' have a function which is the same in kind, e.g. a
lyre, and a good lyre-player, and so without qualification in all cases,
eminence in respect of goodness being idded to the name of the function
