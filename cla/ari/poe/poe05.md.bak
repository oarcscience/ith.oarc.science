...
be cited,--his own Margites, for example, and other similar
...
Moreover, it was not till late that the short plot was discarded for one
of greater compass, and the grotesque diction of the earlier satyric
...
For the iambic is, of all measures, the most colloquial: we see it in
...
and only when we drop the colloquial intonation. The additions to the
