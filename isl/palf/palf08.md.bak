...
Intellects: Passive Intellect, Active Intellect, Actual Intellect,
Acquired Intellect.
...
of Alfarabi with that of St. Thomas for the purpose of helping the
reader discover at a glance the similarity and the difference between
them.
...
he probably would have brought out not only the physical factor, but
also the psychical. For, he seems to take for granted the following
factors which bring about sensation proper. First, without the organs of
the several senses, there can be no sensation. We cannot see without
eyes, nor hear without ears. A sense organ is a *potentia passiva*, the
actuation of which is due to a stimulus, and ultimately to an object.
Second, when the object acts upon the sense-organ, it must produce
therein a modification which is like to itself, and generally called
sensible species. In receiving the sensible species, the sense passes
from potentia passiva to act. Hence, when sensible species are produced
in a sentient organism, they must produce a corresponding reaction which
we call sensation
...
useful to them and avoid what is harmful. "It is by this faculty," he
says, "that the sheep knows that the
...
where the sweet odor is coming from, I am said to have a sensation of
smell. If I refer that "something sweet" to a rose on the table, then I
have a percept of the smell of the rose. From this it follows that
sensation is not knowledge (sentire est nondum scire) .

Man's first knowledge, according to Alfarabi, is a percept. A percept is
a knowledge of the individual, free from abstraction; it is
individuality without universality. It comes after sensation, but prior
to a concept (knowledge of the universal). Literally he says: "There is
...
it the universal. Hence, there is nothing in the intellect that has not
been first in sense-perception.

But a percept is simply incomplete knowledge. To know the individual
completely we must see it and understand it in relation to other
individuals, which is like saying that we must conceive it and think of
it.

For Alfarabi, what is commonly called thought or concept seems to
represent something like the concrete universal, something like the
universal existing in the particular concrete thing.

<span id="page_41">p. 41</span>

<span class="contnote">\[paragraph continues\]</span> This is easily
inferred from his definition of the universal as "Unum de multis et in
multis." By the word "Unum" he means that the universality, that common
something, is abstracted from the concrete thing (percept); and by the
words "de multis et in multis" he means that the universality is to be
...
the concept is seen from the fact that he does not admit in its absolute
sense the aphorism "singulare sentitur, universale intelligitur." He
rather believes that, while by its matter the particular concrete thing
...
"intellect," by which we think, judge and reason. Alfarabi points out
the various meanings of the term "intellect" as used in common speech
and in philosophy proper. In everyday language "an intelligent man," he
...
the faculty by which man attains to the certain knowledge of axioms and
...
an apprehensive power relating to what is above itself, while the
*practical intellect* is a motive power referring to what is below
itself, namely, to the sensitive world that it must govern. The
speculative intellect, as treated by Alfarabi, consists of four
faculties or parts of the soul: the passive and active intellects, the
acquired intellect and the actual intellect.
...
<tr class="odd">
<td data-valign="top" width="327"><p>ALFARABI</p>
<p>The passive intellect or aql hayulani is in potentiality to things intelligible. It passes from potentiality to act when it separates mentally the essence from its individuating notes. This essence, abstracted from the individuals, becomes actually the intelligible form or species which is one and the same as the intellect in act.</p></td>
<td data-valign="top" width="327"><p>ST. THOMAS</p>
<p>The human intellect is in potentiality with regard to things intelligible, and is at first like a clean tablet on which nothing is written. This is made clear from the fact that at first we are only in potentiality to understand and afterwards we are made to understand actually. And so it is evident that with us to understand is in a way to be passive, and consequently the intellect is a passive power. <span id="fr_99"></span><a href="#fn_99">100</a></p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td data-valign="top" width="327"><p>When forms existing in matter outside the soul become actually intelligible, their existence as</p></td>
<td data-valign="top" width="327"><p>Nothing is reduced from potentiality to act except by something in act; as the senses are</p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td data-valign="top" width="327"><p>actually intelligible is not the same as forms existing in matter. For forms existing in matter (individualized concretely) are associated with the various categories of time and place, quantity and quality, but they are stripped of these individuating conditions the moment they become actually intelligible. <span id="fr_100"></span><a href="#fn_100">101</a></p>
<p>The active intellect, or aql faal of which Aristotle speaks in the Anima III, is immaterial....it causes the passive intellect to pass from potentiality to act, and makes the intelligible in potentiality intelligible in act.</p>
<p>The active intellect is related to the passive as the sun is to the eye. The eye is in potentiality to see while it is dark, but it sees actually as soon as light shines. The same is to be said of both the passive and active intellect.</p>
<p>The active intellect shines a kind of light upon the passive, by which the passive becomes actual, (aql bilfil) and the intelligible in potentiality becomes intelligible in act. Furthermore, the active intellect is a separate substance, which, by lighting up the phantasms, makes them to be actually intelligible. <span id="fr_101"></span><a href="#fn_103">104</a></p></td>
<td data-valign="top" width="327"><p>made actual by what is actually sensible. We must therefore assign on the part of the intellect, some power, to make things actually intelligible, by the abstraction of the species from material conditions. And such is the necessity for an active intellect. <span id="fr_102"></span><a href="#fn_101">102</a></p>
<p>The intellectual soul is indeed actually immaterial, but it is in potentiality to determinate species. On the contrary, phantasms are actual images of certain species, but are immaterial in potentiality. Wherefore nothing prevents one and the same soul, inasmuch as it is actually immaterial, having one power by which it makes things actually immaterial, by abstraction from the conditions of individual matter: which power is called the active intellect; and another power, receptive of such species, which is called the passive intellect by reason of its being in potentiality to such species. <span id="fr_103"></span><a href="#fn_102">103</a></p></td>
</tr>
<tr class="even">
<td data-valign="top" width="327"><p> </p></td>
<td data-valign="top" width="327"><p> </p></td>
...
<tr class="odd">
<td data-valign="top" width="327"><p>ALFARABI</p>
<p>The acquired intellect or aql mustafad is simply the actual intellect developed under the inspiration of the active intellect. Albertus Magnus calls it "Intellectus adeptus" <span id="fr_104"></span><a href="#fn_104">106</a></p></td>
<td data-valign="top" width="327"><p>ST. THOMAS</p>
<p>Not only does the active intellect throw light on the phantasm; it does more. By its own power it abstracts the intelligible species from the phantasm. It throws light on the phantasm,</p></td>
</tr>
</tbody>
</table>
...
"By powers of action," says Alfarabi, "are meant those powers which have
action or movement for their object, and they are all grouped under the
name of 'appetite.'" A general law rules our appetitive powers: "Nil
volitum quin fuerit praecognitum." Appetite follows knowledge. For,
appetite can never operate unless something is known and presented to
it. Appetite may be moved either by the sense or by the intellect. If
the appetite is moved by the sense, it becomes sensitive appetite. This
...
appetite (shahuaniat) is a power by which the animal is led to seek what
is useful to it, and to shun what is harmful. Irascible appetite
(Gadibat) is a power by which the animal is aroused to acquire a good
that is difficult to attain, and to remove any evil that would prevent
its attainment. By his concupiscible appetite a dog seeks proper food
and avoids what is injurious; by his irascible appetite he is angered
and attacks the animal that tries to deprive him of his food.

The manifestations of the concupiscible appetite are called
concupiscible passions, and those of the irascible appetite are called
irascible passions.

Alfarabi characterizes the nature of the sensitive appetite by saying
that

It is accompanied by a physical, bodily change. Thus, for instance, when
one is aroused by a great desire to see something, he looks up and
stares at the thing. The
