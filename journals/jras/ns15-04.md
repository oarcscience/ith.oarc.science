...
class="small">1</span></sup>](#page_137_note_1) but the fullest account
...
class="small">2</span></sup>](#page_137_note_2) that individual souls
...
class="small">1</span></sup>](#page_138_note_1) but the text is so full
...
class="small">2</span></sup>](#page_138_note_2) and so I have subjoined
...
class="small">1</span></sup>](#page_155_note_1)--and having his forehead
...
class="small">2</span></sup>](#page_155_note_2) But we cannot say so in
...
class="small">3</span></sup>](#page_155_note_3)--the author thus
...
class="small">4</span></sup>](#page_155_note_4) "thou only," such is not
the meaning of the sentence.<span id="page_155_fr_5"></span>[<sup><span
class="small">5</span></sup>](#page_155_note_5)
...
class="small">1</span></sup>](#page_156_note_1) as in the sentence "as
...
class="small">2</span></sup>](#page_156_note_2)
...
class="small">1</span></sup>](#page_157_note_1) among them. But wherever
...
class="small">1</span></sup>](#page_158_note_1) consequently it must be
...
class="small">2</span></sup>](#page_158_note_2)
...
class="small">3</span></sup>](#page_158_note_3)
...
class="small">1</span></sup>](#page_159_note_1) but the knowledge of the
...
class="small">2</span></sup>](#page_159_note_2)
...
class="small">3</span></sup>](#page_159_note_3) in the Veda by the
...
class="small">4</span></sup>](#page_159_note_4) "Speech retires
...
class="small">1</span></sup>](#page_160_note_1)--from this saying it is
...
class="small">2</span></sup>](#page_160_note_2)
...
class="small">3</span></sup>](#page_160_note_3)--surely such words of
...
class="small">4</span></sup>](#page_160_note_4)
...
class="small">5</span></sup>](#page_160_note_5) for in all effects, as
...
class="small">6</span></sup>](#page_160_note_6)--I see no difference
whatever."
...
class="small">1</span></sup>](#page_161_note_1) \[of human infirmity,\]
...
class="small">2</span></sup>](#page_161_note_2) and alter; hence one may
...
class="small">3</span></sup>](#page_161_note_3)\],--there is nothing
deficient but everything is present in the Lord's body,<span
id="page_161_fr_4"></span>[<sup><span
class="small">4</span></sup>](#page_161_note_4) since He is the husband
of Lakshmî.
...
class="small">5</span></sup>](#page_161_note_5)
...
class="small">6</span></sup>](#page_161_note_6)
...
class="small">1</span></sup>](#page_162_note_1)--and to be discovered by
...
class="small">2</span></sup>](#page_162_note_2) from the mention there
...
class="small">1</span></sup>](#page_163_note_1) the result would be the
abolition of His being out of sight,<span
id="page_163_fr_2"></span>[<sup><span
class="small">2</span></sup>](#page_163_note_2) but in no way Oneness.
...
class="small">3</span></sup>](#page_163_note_3)
...
class="small">4</span></sup>](#page_163_note_4) and thus has it been
...
class="small">5</span></sup>](#page_163_note_5) thus their difference is
...
class="small">6</span></sup>](#page_163_note_6)
...
class="small">1</span></sup>](#page_164_note_1) is precluded; or they
bring forward such words as *d.rishadupala* as parallel cases;<span
id="page_164_fr_2"></span>[<sup><span
class="small">2</span></sup>](#page_164_note_2) the *dvandva* is only
...
class="small">3</span></sup>](#page_164_note_3)
...
class="small">4</span></sup>](#page_164_note_4) so too this passage "I
am Brahman" is to be understood as meaning worship.<span
id="page_164_fr_5"></span>[<sup><span
class="small">5</span></sup>](#page_164_note_5)
...
class="small">1</span></sup>](#page_166_note_1)--amidst all the six
...
class="small">2</span></sup>](#page_166_note_2)
...
class="small">1</span></sup>](#page_167_note_1) So the individual souls
...
class="small">2</span></sup>](#page_167_note_2)
...
class="small">3</span></sup>](#page_167_note_3) there must be a real
...
class="small">4</span></sup>](#page_167_note_4) so too when the souls
...
class="small">1</span></sup>](#page_168_note_1) (Purâ.na).
...
class="small">4</span></sup>](#page_168_note_4) were afterwards
...
class="small">5</span></sup>](#page_168_note_5)--it is but like the
...
class="small">1</span></sup>](#page_169_note_1) is said to be the
...
class="small">2</span></sup>](#page_170_note_2) but to imagine that
...
class="small">3</span></sup>](#page_170_note_3) but this is not a
...
class="small">4</span></sup>](#page_170_note_4)
...
class="small">1</span></sup>](#page_171_note_1) thou art made pure by
...
class="small">2</span></sup>](#page_171_note_2)
...
class="small">3</span></sup>](#page_171_note_3)
...
class="small">1</span></sup>](#page_172_note_1) even Brahman himself
...
class="small">2</span></sup>](#page_172_note_2)
...
class="small">1</span></sup>](#page_173_note_1) abide for ever,--whose
...
<span id="page_137_note_1"></span>[1](#page_137_fr_1). Works, vol. i.
pp. 139-150. See also Prof. Monier Williams, J.R.A.S. Vol. XIV. N.S. p.
304.

<span id="page_137_note_2"></span>[2](#page_137_fr_2). As the different
...
<span id="page_156_note_2"></span>[2](#page_156_fr_2). This is another
...
<span id="page_157_note_1"></span>[1](#page_157_fr_1). Dr. Banerjea
...
<span id="page_158_note_1"></span>[1](#page_158_fr_1). In such sentences
...
<span id="page_158_note_2"></span>[2](#page_158_fr_2). I suppose that
...
<span id="page_158_note_3"></span>[3](#page_158_fr_3). Cf. the Bengali
proverb *mâthâ nâi târ mâthâbyathâ*, "he has no head and yet he has a
headache."

<span id="footnotes_page_159"></span>p. 159

<span id="page_159_note_1"></span>[1](#page_159_fr_1). In the first ex.
...
<span id="page_159_note_2"></span>[2](#page_159_fr_2). He seems to imply
...
<span id="page_159_note_3"></span>[3](#page_159_fr_3). He now proceeds
to declare his own opinions.

<span id="page_159_note_4"></span>[4](#page_159_fr_4). Taitt. Upanish.
ii. 4.

<span id="footnotes_page_160"></span>p. 160

<span id="page_160_note_1"></span>[1](#page_160_fr_1). Cf. the Ka.tha
Up. vi. 12, "The soul is not to be reached by speech nor by the mind nor
by the eye."

<span id="page_160_note_2"></span>[2](#page_160_fr_2). For
*skhaladgati*, cf. *Kâvyaprakâša*, ii. 16.

<span id="page_160_note_3"></span>[3](#page_160_fr_3). This line is
quoted from Šruti in the Maitri Upanishad, vi. 22.

<span id="page_160_note_4"></span>[4](#page_160_fr_4). Cf.
...
<span id="page_160_note_5"></span>[5](#page_160_fr_5). This is one of
the tenets of Râmânujas as well as Pûr.naprajñas.

<span id="page_160_note_6"></span>[6](#page_160_fr_6). The *vyâpâra* or
intermediate agency is defined as *taj-janyatve sati taj-janya-janako hi
vyâpâra.h*.

<span id="footnotes_page_161"></span>p. 161

<span id="page_161_note_1"></span>[1](#page_161_fr_1). Compare the
memorial line, *Šokamohau jarâm.rityû kshutpipâse sha.dûrmaya.h*.

<span id="page_161_note_2"></span>[2](#page_161_fr_2). With this curious
...
<span id="page_161_note_3"></span>[3](#page_161_fr_3). Could *loke* mean
that it will hold good "of the world" as his body?

<span id="page_161_note_4"></span>[4](#page_161_fr_4). Cf. "Whose body
nature is and God the soul."

<span id="page_161_note_5"></span>[5](#page_161_fr_5). *I.e.* he creates
the world to give their deserts to the different souls.

<span id="page_161_note_6"></span>[6](#page_161_fr_6). The objector
...
<span id="page_162_note_1"></span>[1](#page_162_fr_1). These six
...
<span id="page_162_note_2"></span>[2](#page_162_fr_2). Rig V. i. 164,
...
<span id="page_163_note_1"></span>[1](#page_163_fr_1). Another reading
is *brahma.ny âtmanirîksha.nât*.

<span id="page_163_note_2"></span>[2](#page_163_fr_2). *I.e.* it would
be always *videre videntem*.

<span id="page_163_note_3"></span>[3](#page_163_fr_3). Cf. Hitopadeša,
Introd. šl. 45.

<span id="page_163_note_4"></span>[4](#page_163_fr_4). In Vedânta S. i.
...
<span id="page_163_note_5"></span>[5](#page_163_fr_5). Cf. Vedânta
...
<span id="page_163_note_6"></span>[6](#page_163_fr_6). He uses this very
expression *upâsyopâsakabhâva* in his Comment. on i. 2. 4.

<span id="footnotes_page_164"></span>p. 164

<span id="page_164_note_1"></span>[1](#page_164_fr_1). *I.e.* in the
word *jîvâtmânau*.

<span id="page_164_note_2"></span>[2](#page_164_fr_2). I suppose that
...
<span id="page_164_note_3"></span>[3](#page_164_fr_3). But *jîvâtmânau*
is a *dvandva*, not a *karmadhâraya* compound.

<span id="page_164_note_4"></span>[4](#page_164_fr_4). Brihad Âra.nyaka
Upan. v. 12. 1.

<span id="page_164_note_5"></span>[5](#page_164_fr_5). *I.e.* this is
...
<span id="page_166_note_1"></span>[1](#page_166_fr_1). Colebrooke's
Essays, vol i. p. 359.

<span id="page_166_note_2"></span>[2](#page_166_fr_2). This is an attack
...
<span id="page_167_note_1"></span>[1](#page_167_fr_1). *I.e.* those
...
<span id="page_167_note_2"></span>[2](#page_167_fr_2). In allusion to
Mu.n.d. Upan. iii. 2. 8.

<span id="page_167_note_3"></span>[3](#page_167_fr_3). Most of the MSS.
...
<span id="page_167_note_4"></span>[4](#page_167_fr_4). Cf. Šakunt. šl.
155.

<span id="footnotes_page_168"></span>p. 168

<span id="page_168_note_1"></span>[1](#page_168_fr_1). Bhâg. Pûr. iii.
28. 41.

<span id="page_168_note_2"></span>[2](#page_168_fr_2). The name
...
<span id="page_168_note_3"></span>[3](#page_168_fr_3). Mahâbh. xii.
9690.

<span id="page_168_note_4"></span>[4](#page_168_fr_4). This dialogue
occurs in Mahâbh. xii. 9604, ff.

<span id="page_168_note_5"></span>[5](#page_168_fr_5). The Râmânujas and
...
<span id="page_169_note_1"></span>[1](#page_169_fr_1). This is the
...
<span id="page_169_note_2"></span>[2](#page_169_fr_2). Clearer insight
...
<span id="page_170_note_1"></span>[1](#page_170_fr_1). I do not know
where this passage occurs, but the kindred word *satyadharman* is
applied to several deities in the Rigveda.

<span id="page_170_note_2"></span>[2](#page_170_fr_2). The Vedântins
...
<span id="page_170_note_3"></span>[3](#page_170_fr_3). It is a favourite
doctrine of the Vedânta that ignorance, as being imagined by ignorance,
is itself false.

<span id="page_170_note_4"></span>[4](#page_170_fr_4). Manu, i. 80,
...
<span id="page_171_note_1"></span>[1](#page_171_fr_1). Or this may mean
"since Vish.nu has accepted it as the instrument of his sport."

<span id="page_171_note_2"></span>[2](#page_171_fr_2). "The *prasâda* is
...
<span id="page_171_note_3"></span>[3](#page_171_fr_3). But the true
...
<span id="page_172_note_1"></span>[1](#page_172_fr_1). Cf. Sarva D. S.
...
<span id="page_172_note_2"></span>[2](#page_172_fr_2). Cf. the šloka in
the prologue of the Mâlatîmâdhava.

<span id="footnotes_page_173"></span>p. 173

<span id="page_173_note_1"></span>[1](#page_173_fr_1). Or "the necklace
