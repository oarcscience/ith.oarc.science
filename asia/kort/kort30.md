...
NOTE.--In the lists given below, the numbers in parentheses indicate
...
    A<sup>?</sup>qe'p-e'ñer (= nail-star).
...
    wołva'kI-r-i'mtiła<sup>?</sup>n (= crosswise-bow carrier).
...
\(2\) ya<sup>?</sup>'-ve'yem (= clay river).

\(3\) čeġai'-va'am (=pebbly river).

    ya<sup>?</sup>-va'am (=clay river).
...
\(1\) čê'Ło-ma<sup>?</sup>'qIm (= copper arrow-head).
...
\(3\) ġaka'ñIla<sup>?</sup>n (= one driving with reindeer).
...
dialect, a second form of the stem used in oblique cases (cf. p. 4). I
have also corrected some evident errors (cr. Jochelson, The Koryak, *l.
c.*, vol. vi, p. 123); namely, *eñe'y* instead of *eñen*, *Evan'venañ*
instead of *Ena'nvenañāña*, *Yekeñeła'tIlIn* (or also
*Yekeñeła<sup>?</sup>n*) of instead of *Yeke'ñelaqlIn*,
...
handle of her scraper. Among the Reindeer Koryak, the Belt (if Orion is
called Kĭlu'-ena'nvenañ ("Kĭlu''s handle of scraper"). The Koryak
