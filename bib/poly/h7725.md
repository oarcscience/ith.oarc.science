...
intransitively, literally or figuratively (not necessarily with the idea
of *return* to the starting point); generally to *retreat*; often
adverbially *again: -* (\[break, build, circumcise, dig, do anything, do
...
recover, refresh, relieve, render (again), X repent, requite, rescue,
restore, retrieve, (cause to, make to) return, reverse, reward, + say
nay, send back, set again, slide back, still, X surely, take back (off),
