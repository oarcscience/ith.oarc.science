...
[Index](index)  [Previous](aia04)  [Next](aia06.md) 
...
place, draw three circles, as in [figure 1](#img_fig01.md); and then draw
...
1\. Learn in an ephemeris <span id="fr_8"></span>[1](#fn_8.md) for the year
...
number of hours and minutes which have elapsed since that noon: <span
id="fr_9"></span>[2](#fn_9.md) the sum will be the right ascension in time
...
<span id="fn_8"></span>[22:1](aia05.htm#fr_8.md) Ephemeris signifies a
