...
[Index](index)  [Previous](sbe48185)  [Next](sbe48187) 

------------------------------------------------------------------------

16\. And because (the cause) is perceived in the existence of the
effect.
...
has passed over into a different condition. He also who holds the effect
to be a new thing acknowledges that the effect is connected with a
different state, and as this different state suffices to account for the
...
*things* being different, but having the same generic nature); for we
...
cause (samavâyi-kâra,ina). For where there is difference of substances
...
case, we reply; here also we *do* recognise in the effect that substance
