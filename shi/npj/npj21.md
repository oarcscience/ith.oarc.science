...
SEAMI tells us (*Works*, p. 246) that this play was written by Enami no
Sayemon. "But as I removed bad passages and added good ones, I consider
the play to be really my work"--(p. 247).

On p. 245 he points out that the same play on words occurs in Ukai three
times, and suggests how one passage might be amended. The text of the
play which we possess to-day still contains the passages which Seami
ridiculed, so that it must be Enami no Sayemon's version which has
survived, while Seami's amended text is lost.
...
much earlier, seems to be the seed from which the Nō play Ukai grew.
