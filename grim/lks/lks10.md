...
vestment, and covered with a cloth of fine linen white and pure, the
...
Maltese crosses black; the five exterior

<span id="page_51">p. 51</span>

triangles of the Hexagram where Te, tra, gram, ma, ton, is written, are
filled in with bright yellow; the T cross in centre is red, with the
three little squares therein in black. The lower exterior triangle,
where the Sigil is drawn in black, is left white. The words
"Tetragrammaton" and "Tau" are in black letters; and AGLA with Alpha and
Omega in red letters.)
