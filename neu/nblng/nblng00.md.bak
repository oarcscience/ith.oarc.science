...
New York, 1909). This edition is in the PUBLIC DOMAIN in the United
States.
...
In order to make this electronic edition easier to use, the preparer has
found it necessary to re-arrange the endnotes of Mr. Shumway's edition,
collating them with the chapters themselves and substituting page
references with footnote references. The preparer takes full
responsibility for these changes.--DBK.
