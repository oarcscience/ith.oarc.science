...
were to Solomon. This collection, which presumably was always elastic in
extent, was known as "The High One's Words," and forms the basis of the
present poem. To it, however, were added other poems and fragments
...
comprising the main collection. Here and there bits of verse more nearly
narrative crept in; and of course the loose structure of the poem made
it easy for any reciter to insert new stanzas almost at will. This
curious miscellany is what we now have as the *Hovamol*.

Five separate elements are pretty clearly recognizable: (1) the
*Hovamol* proper (stanzas 1-80), a collection of proverbs and counsels
for the conduct of life; (2) the *Loddfafnismol* (stanzas 111-138), a
collection somewhat similar to the first, but specific ally addressed to
a certain Loddfafnir; (3) the *Ljothatal* (stanzas 147-165), a
collection of charms; (4) the love-story of Othin and Billing's daughter
(stanzas 96-102), with an introductory dissertation on the faithlessness
of women in general (stanzas 81-95), which probably crept into the poem
...
ancient Germanic poetry; parts of it may have originated at a relatively
late period. Probably, however, most of its component elements go pretty
far back, although we have no way of telling how or when they first
became associated.
...
last two lines of stanza it, as in the manuscript the first two lines of
...
\[36. The manuscript has "little" in place of "a hut" in line I, but
this involves an error in the initial-rhymes, and the emendation has
been generally accepted.

37\. Lines I and 2 are abbreviated in the manuscript, but are doubtless
identical with the first two lines of stanza 56.
...
65\. The manuscript indicates no lacuna (lines I and 2). Many editors
...
corpse" in line I, but Rask suggested the emendation as early as 1818,
...
interpolated, and line I has little enough connection with lines 3, 4
...
\[76. in the manuscript this stanza follows 79, the order being: 77, 78,
...
stanzas on love in the regular measure of the *Hovamol* (stanza 91-9s),
is introduced, by way of illustration, Othin's story of his \[fp. 46\]
adventure with Billing's daughter (stanzas 96-102). Some such process of
growth, whatever its specific stages may have been, must be assumed to
account for the curious chaos of the whole passage from stanza 81 to
stanza 102.\]
...
85\. Stanzas 85-88 and go are in Fornyrthislag, and clearly come from a
...
\[89. This stanza follows stanza 89 in the manuscript. Many editors have
...
if it breaks in between 87 and 88.\]
...
falseness of woman by the story of Othin's unsuccessful love affair with
...
He makes these two lines plus lines I and 2 a full stanza, and line 3,
...
draught of which conferred the gift of poetry. Othin, desiring to obtain
it, changed himself into a snake, bored his way through a mountain into
Suttung's home, made love to the giant's daughter, Gunnloth, and by her
connivance drank up all the mead. Then he flew away in the form of an
eagle, leaving Gunnloth to her fate. While with Suttung he assumed the
name of Bolverk ("the Evil-Doer").

105\. *Rati* ("the Traveller"): the gimlet with which Othin bored
through the mountain to reach Suttung's home.\]
...
identical with Bolverk, possibly because the oath referred to in stanza
I to was an oath made by Othin to Suttung that there was no such person
as Bolverk among the gods. The giants, of course, fail to get from Othin
the information they seek concerning Bolverk, but Othin is keenly
conscious of having violated the most sacred of oaths, that sworn on his
ring.\]
...
have tried many experiments with it, both in rejecting lines as spurious
and in rear ranging the words and punctuation. It looks rather as though
the first four lines formed a complete stanza, and the last four had
crept in later. The phrase translated "the speech of Hor" is "Hova mol,"
...
126 and 130) the formula precedes a full four-line stanza instead of two
(or three) lines.\]
...
stanza. Others, attaching lines 3 and 4 to stanza 132, insert as the
first two lines of stanza 133 two lines from a late paper manuscript,
running:
...
together. The wrinkled skin of the old man is \[fp. 59\] compared with
the dried skins and bellies of animals kept for various purposes hanging
...
beam (bolt) which is ever being raised to admit guests be comes weak
thereby. It needs a ring to help it in keeping the door closed, and
without the ability at times to ward off guests a man becomes the victim
...
poem, following stanza 165. Most recent editors have followed Müllenhoff
in shifting it to this position, as it appears to conclude the passage
introduced by the somewhat similar stanza 111.
...
miscellaneous sources, all, however, dealing with the general subject of
runes. With stanza 147 a clearly continuous passage begins once more.
*The windy tree*: the ash Yggdrasil (literally "the Horse of Othin," so
called be cause of this story), on which Othin, in order to win the
magic runes, hanged himself as an offering to himself, and wounded
himself with his own spear. Lines 5 and 6 have presumably been borrowed
from *Svipdagsmol*, 30.\]
...
stanza is most obscure. Bolthorn was Othin's grandfather, and Bestla his
mother. We do not know the name of the uncle here mentioned, but it has
been suggested that this son of Bolthorn was Mimir (cf. *Voluspo*, 27
...
name. The two names also appear together in *Grimnismol*, 33, where they
are applied to two of the four harts that nibble at the topmost twigs of
Yggdrasil. *Alsvith* ("the All Wise") appears nowhere else as a giant's
name. *Myself*: Othin. We have no further information concerning the
list of those who wrote the runes for the various races, and these four
...
concerned less with the runes which one "writes" and "tints" (cf. stanza
79) than with the prayers which one "asks" and the sacrifices which one
"offers" and "sends." Its origin is wholly uncertain, but it is clearly
an interpolation here. In the manuscript the phrase "knowest?" is
...
In the manuscript and in most editions line 4 falls into two half-lines,
running:
...
houses, generally in the form of wild beasts. Possibly one of the last
two lines is spurious.
...
(Night). Their son was Dag (Day). *Thjothrörir*: not mentioned
...
Others have assumed that the gap follows the first half-line, making "so
...
apparent excuse for the reference to Loddfafnir at this point. The words
