...
Hermetica](../index)  [Index](index)  [Previous](th342)  [Next](th344) 
...
id="fr_725"></span>[1](#fn_725) is of prime importance seeing that it
...
with these significant words <span id="fr_726"></span>[1](#fn_726):
...
sacred sermons\]. <span id="fr_727"></span>[2](#fn_727) And so it was to
...
such subjects. <span id="fr_728"></span>[3](#fn_728) And if we also
...
Greeks, <span id="fr_729"></span>[4](#fn_729) should have obtained
fitting instruction
...
Teachers.’” <span id="fr_730"></span>[1](#fn_730)
...
of a “Hermaïc” <span id="fr_731"></span>[1](#fn_731) nature; the more
...
twenty thousand books, as Seleucus <span id="fr_732"></span>[1](#fn_732)
...
id="fr_733"></span>[2](#fn_733) some of the sub-states and others
others.” <span id="fr_734"></span>[3](#fn_734)
...
id="fr_735"></span>[1](#fn_735) that most sacred time-period of the
...
the celestial.” <span id="fr_736"></span>[1](#fn_736)
...
in philosophy.” <span id="fr_737"></span>[1](#fn_737)
...
nature, <span id="fr_738"></span>[2](#fn_738) not only in the case of
...
several spheres. <span id="fr_739"></span>[3](#fn_739) And they do not
...
id="fr_740"></span>[4](#fn_740) they reach higher and more

<span id="page_293">p. 293</span>

universal states \[of consciousness\] above the \[Seven Spheres of\]
Destiny, ascending to God the Creator, <span
id="fr_741"></span>[1](#fn_741) and that too without using any material
means, or any other \[material\] assistance than the observation of a
suitable opportunity.

“It was Hermes who first taught this Path. <span
id="fr_742"></span>[2](#fn_742) And Bitys, the prophet, translated \[his
teachings concerning it\] for King Ammon, <span
id="fr_743"></span>[3](#fn_743) discovering them in the inner
temple <span id="fr_744"></span>[4](#fn_744) in an inscription in the
...
pervadeth the whole universe.’” <span id="fr_745"></span>[5](#fn_745)
...
the Hermaïc Books.” <span id="fr_746"></span>[6](#fn_746)
...
id="fr_747"></span>[7](#fn_747) But what are we to understand by
...
the First Man.” <span id="fr_748"></span>[1](#fn_748)

The identity of Bitys and Bitos is thus unquestionable. <span
id="fr_749"></span>[2](#fn_749) Reitzenstein, however, asserts that
...
Papyri, <span id="fr_750"></span>[3](#fn_750) as Dieterich has
...
King, <span id="fr_751"></span>[4](#fn_751) referring to a passage of
...
id="fr_752"></span>[1](#fn_752) deserves our closest attention in this
...
id="fr_753"></span>[1](#fn_753) His name, Ysdnw, was derived by the
...
medicine. <span id="fr_754"></span>[2](#fn_754) Some of the
prescriptions quoted as from him are quite in the Egyptian style. <span
id="fr_755"></span>[3](#fn_755) Philo Byblius, on whom, to be sure, not
much reliance can be placed, <span id="fr_756"></span>[4](#fn_756)
mentions a book of Ostanes—the *Octateuch*. <span
id="fr_757"></span>[5](#fn_757) It is tempting to identify this with
some such collection as the six medical books which occupy the last
place in Clement’s list. <span id="fr_758"></span>[6](#fn_758) Now
...
doctrines of Hermes, <span id="fr_759"></span>[1](#fn_759) and clearly
...
id="fr_760"></span>[2](#fn_760) we append a passage to show the striking
...
Power of the Creator, <span id="fr_761"></span>[3](#fn_761) while the
other, the soul under constraint, comes from the revolution of the
celestial \[Spheres\] <span id="fr_762"></span>[4](#fn_762); into the
...
from the worlds <span id="fr_763"></span>[5](#fn_763) keeps time with
...
Genesis, <span id="fr_764"></span>[1](#fn_764) brought to its
consummation.” <span id="fr_765"></span>[2](#fn_765)
...
in partial manifestation, <span id="fr_766"></span>[3](#fn_766) we must
...
id="fr_767"></span>[4](#fn_767) therefore, being from the first set in
the celestial revolutions of the æthereal *Soul*, <span
id="fr_768"></span>[5](#fn_768) for ever continue in this relationship;
while the *Souls* of the \[invisible\] Worlds, <span
id="fr_769"></span>[6](#fn_769) extending to their \[common\] *Mind*,
are completely
...
in superior states of existence.” <span id="fr_770"></span>[1](#fn_770)
...
it.” <span id="fr_771"></span>[2](#fn_771)
...
these Spheres the Star <span id="fr_772"></span>[3](#fn_772) we see is
the Ruler. Now Fixed Stars differ from those <span
id="fr_773"></span>[4](#fn_773) in the Planetary Spheres in that the
former have but one Monad, namely, their system as a whole <span
id="fr_774"></span>[5](#fn_774); while the latter, namely the invisible
...
id="fr_775"></span>[6](#fn_775) and that dominant characteristic which
...
to their respective spheres. <span id="fr_776"></span>[1](#fn_776) And
that in each of these spheres there is a host <span
id="fr_777"></span>[2](#fn_777) on the same level <span
id="fr_778"></span>[3](#fn_778) with each, you may infer from the
extremes. <span id="fr_779"></span>[4](#fn_779) For if the Fixed
Sphere <span id="fr_780"></span>[5](#fn_780) has a host on the same
level as itself, and Earth has a host of earthy animals, <span
id="fr_781"></span>[6](#fn_781) just as the former a host of heavenly
animals, <span id="fr_782"></span>[7](#fn_782) it is necessary that
every whole <span id="fr_783"></span>[8](#fn_783) should have a number
...
<span id="fn_725"></span>[285:1](th343.htm#fr_725) The exact date of
...
<span id="fn_726"></span>[286:1](th343.htm#fr_726) I translate from the
text of Parthey (Berlin, 1857).

<span id="fn_727"></span>[286:2](th343.htm#fr_727) The term λόγος is, of
course, used technically, as a sacred or inspired sermon or course of
instruction.

<span id="fn_728"></span>[286:3](th343.htm#fr_728) πάντα τὰ οἰκεῖα
συγγράμματα.

<span id="fn_729"></span>[286:4](th343.htm#fr_729) Parthey here adds the
...
<span id="fn_730"></span>[287:1](th343.htm#fr_730) That is to say,
presumably, teachers of all without distinction of race. *Op. cit*., i.
1.

<span id="fn_731"></span>[288:1](th343.htm#fr_731) It is from this
...
<span id="fn_732"></span>[289:1](th343.htm#fr_732) Porphyry (*De Abs*.,
...
<span id="fn_733"></span>[289:2](th343.htm#fr_733) Reading διαλαβόντες
instead of διαβάλλοντες.

<span id="fn_734"></span>[289:3](th343.htm#fr_734) *Ibid.*, viii. 1.

<span id="fn_735"></span>[290:1](th343.htm#fr_735) See Georgius
Syncellus, *Chron*., i. 97, ed. Dindorf. Also Eusebius, *Chron*., vi.

<span id="fn_736"></span>[291:1](th343.htm#fr_736) *Op. cit*., viii. 2.

<span id="fn_737"></span>[292:1](th343.htm#fr_737) *Ibid.*, viii. 4.

<span id="fn_738"></span>[292:2](th343.htm#fr_738) That is, the life of
the body.

<span id="fn_739"></span>[292:3](th343.htm#fr_739) Lit. distributed to
all the spheres as different.

<span id="fn_740"></span>[292:4](th343.htm#fr_740) διὰ τῆς ἱερατικῆς
θεουργίας,—lit. by the theurgy known to the priests.

<span id="fn_741"></span>[293:1](th343.htm#fr_741) The Mind in its
creative aspect.

<span id="fn_742"></span>[293:2](th343.htm#fr_742) *Sc.* This Way up to
God.

<span id="fn_743"></span>[293:3](th343.htm#fr_743) See Commentary on *C.
H.* (xvi.).

<span id="fn_744"></span>[293:4](th343.htm#fr_744) Or secret shrine.

<span id="fn_745"></span>[293:5](th343.htm#fr_745) *Op. cit.*, viii. 5.

<span id="fn_746"></span>[293:6](th343.htm#fr_746) *Ibid.*, x. 7.

<span id="fn_747"></span>[293:7](th343.htm#fr_747) Identified by some
...
<span id="fn_748"></span>[295:1](th343.htm#fr_748) See notes appended to
the extract from Zosimus.

<span id="fn_749"></span>[295:2](th343.htm#fr_749) As has already been
