...
[Index](index)  [Previous](sbe1919)  [Next](sbe1921) 

------------------------------------------------------------------------

### VARGA 18. CONVERSION OF <span id="fr_518"></span>[3](#fn_518) THE 'SUPPORTER OF THE ORPHANS AND DESTITUTE <span id="fr_519"></span>[4](#fn_519)' (ANÂTHAPI*ND*ADA).

At this time there was a great householder <span
id="fr_520"></span>[5](#fn_520) whose name was 'Friend of the Orphan and
...
Ko*s*ala <span id="fr_521"></span>[6](#fn_521), stopped at the house of
a friend whose name was Sheu-lo <span id="fr_522"></span>[7](#fn_522)
...
id="fr_523"></span>[1](#fn_523) for the grove. <span class="margnote">.
1434</span>

Tathâgata, well aware of his character, and that he was prepared to
bring forth purity and faith <span id="fr_524"></span>[2](#fn_524),
according to the case, called him by his true <span
id="fr_525"></span>[3](#fn_525) (name), and for his sake addressed him
in words of religion: <span class="margnote">. 1435</span>

'Having rejoiced in the true law <span id="fr_526"></span>[4](#fn_526),
and being humbly <span id="fr_527"></span>[5](#fn_527) desirous for a
...
meeting <span id="fr_528"></span>[6](#fn_528). In your former births the
root of virtue planted firm in pure and rare expectancy <span
id="fr_529"></span>[7](#fn_529), <span class="margnote">. 1437</span>
...
'Now, therefore, take from me <span id="fr_530"></span>[1](#fn_530) the
charity of perfect rest (Nirvâ*n*a), and for this end accept my rules of
purity. My rules <span id="fr_531"></span>[2](#fn_531) are full of
...
id="fr_532"></span>[3](#fn_532)" all search, for "giving up" desire is
the joy of perfect rest (Nirvâ*n*a) <span
id="fr_533"></span>[4](#fn_533). Know <span
id="fr_534"></span>[5](#fn_534) then! that age, disease,
...
id="fr_535"></span>[1](#fn_535)?" Know then! that "sorrow" is this very
sorrow (viz. of knowledge), and its repetition is "accumulation <span
id="fr_536"></span>[2](#fn_536);" <span class="margnote">. 1445</span>

'Destroy <span id="fr_537"></span>[3](#fn_537) this sorrow and there is
joy, the way <span id="fr_538"></span>[4](#fn_538) is in the calm and
...
id="fr_540"></span>[1](#fn_540), the place of immortality <span
id="fr_541"></span>[2](#fn_541) and rest. <span class="margnote">.
1448</span>
...
id="fr_542"></span>[3](#fn_542) degree of holiness, he emptied, as it
were, the sea of birth and death, one drop <span
id="fr_543"></span>[4](#fn_543) alone remaining. <span
...
condition, not <span id="fr_544"></span>[1](#fn_544) as common folk do
...
fast cords of lust <span id="fr_545"></span>[2](#fn_545). The nobleman
...
He argued <span id="fr_546"></span>[3](#fn_546) not that Î*s*vara was
...
id="fr_547"></span>[4](#fn_547), there should be neither young nor old,
...
self-existent <span id="fr_548"></span>[1](#fn_548), because in that he
...
id="fr_549"></span>[2](#fn_549), and therefore not the self-existent
...
'For if he causes grief <span id="fr_550"></span>[3](#fn_550) and joy,
he must himself
...
not, the blame is ours <span id="fr_551"></span>[1](#fn_551). <span
class="margnote">. 1468</span>

'Again, if it be said self-nature <span id="fr_552"></span>[2](#fn_552)
is the maker, this

<span id="page_209">p. 209</span>

is as faulty as the first assertion; nor has either of the
Hetuvidyâ <span id="fr_553"></span>[1](#fn_553) *s*âstras asserted such
...
time <span id="fr_554"></span>[2](#fn_554);" know then for certain
...
gu*n*as <span id="fr_555"></span>[1](#fn_555) (modifications), therefore
...
id="fr_556"></span>[2](#fn_556) (aim), it
...
"expedients." The To-lo-piu Kiu-na <span id="fr_557"></span>[1](#fn_557)
...
"self <span id="fr_558"></span>[2](#fn_558)" is maker, then surely self
...
evil karman <span id="fr_559"></span>[1](#fn_559); <span
...
according to occasion <span id="fr_560"></span>[2](#fn_560) (time), and
...
id="fr_561"></span>[3](#fn_561); <span class="margnote">. 1493</span>
...
The nobleman <span id="fr_562"></span>[4](#fn_562) (householder), his
...
id="fr_563"></span>[1](#fn_563), a land rich in produce, and enjoying
peace; Prasena*g*it (Pasenit) <span id="fr_564"></span>[2](#fn_564) is
...
id="fr_565"></span>[1](#fn_565)," and that accumulated sorrow, when he
...
follows--hard to conjecture <span id="fr_566"></span>[2](#fn_566)! <span
...
id="fr_567"></span>[3](#fn_567). <span class="margnote">. 1509</span>
...
eightfold <span id="fr_568"></span>[1](#fn_568) path of recollection,
...
'The charity which unstores <span id="fr_569"></span>[2](#fn_569) wealth
...
'Founding religious rest-places <span id="fr_570"></span>[3](#fn_570)
(pure abodes) we
...
id="fr_571"></span>[1](#fn_571)!' The nobleman accepting Buddha's
teaching, his kindly heart receiving yet more light, <span
class="margnote">. 1520</span>

He invited Upatishya <span id="fr_572"></span>[2](#fn_572), his
...
else, you may possess it <span id="fr_573"></span>[3](#fn_573).' <span
...
id="fr_574"></span>[1](#fn_574) (charity), and *G*eta too, knowing the
...
id="fr_575"></span>[1](#fn_575); <span class="margnote">. 1531</span>
...
<span id="fn_518"></span>[201:3](sbe1920.htm#fr_518) Literally, 'he
converts,' &c.

<span id="fn_519"></span>[201:4](sbe1920.htm#fr_519) This is the Chinese
...
<span id="fn_520"></span>[201:5](sbe1920.htm#fr_520) The Chinese is
...
<span id="fn_521"></span>[201:6](sbe1920.htm#fr_521) That is, Uttara
Ko*s*ala (Northern Ko*s*ala), the capital of which was *S*râvastî.

<span id="fn_522"></span>[201:7](sbe1920.htm#fr_522) Rhys Davids gives
...
<span id="fn_523"></span>[202:1](sbe1920.htm#fr_523) The statements that
...
<span id="fn_524"></span>[202:2](sbe1920.htm#fr_524) That is, that he
was ripe for conversion.

<span id="fn_525"></span>[202:3](sbe1920.htm#fr_525) The name by which
he was called, according to Spence Hardy (Manual of Buddhism, p. 217),
was Sudatta.

<span id="fn_526"></span>[202:4](sbe1920.htm#fr_526) That is, 'because'
you have rejoiced. The 'true law' is the same as 'religious truth.'

<span id="fn_527"></span>[202:5](sbe1920.htm#fr_527) Literally, 'pure
and truthful of heart, with meekness thirsting (after knowledge).'

<span id="fn_528"></span>[202:6](sbe1920.htm#fr_528) The meaning is, as
we have now met for the first time, I will explain my doctrine (preach)
in a formal (polite) way.

<span id="fn_529"></span>[202:7](sbe1920.htm#fr_529) That is, your merit
in former births has caused you to reap a reward in your present
condition.

<span id="fn_530"></span>[203:1](sbe1920.htm#fr_530) The construction
...
<span id="fn_531"></span>[203:2](sbe1920.htm#fr_531) Instead of 'my
rules,' it would be better to understand the word in an indefinite sense
as 'rules of morality' (*s*îla).

<span id="fn_532"></span>[203:3](sbe1920.htm#fr_532) 'Giving up,' that
...
<span id="fn_533"></span>[203:4](sbe1920.htm#fr_533) This definition of
...
<span id="fn_534"></span>[203:5](sbe1920.htm#fr_534) It would seem, from
the context, that the word '*k*i' (know), in this line, is a mistake for
'sing,' birth.

<span id="fn_535"></span>[204:1](sbe1920.htm#fr_535) The argument is,
...
<span id="fn_536"></span>[204:2](sbe1920.htm#fr_536) The sorrow of
'accumulation' is the second of the 'four truths' (according to Northern
accounts).

<span id="fn_537"></span>[204:3](sbe1920.htm#fr_537) 'Destruction' is
the third great truth.

<span id="fn_538"></span>[204:4](sbe1920.htm#fr_538) The 'way' is the
fourth truth.

<span id="fn_539"></span>[204:5](sbe1920.htm#fr_539) The sentiment here
...
<span id="fn_540"></span>[205:1](sbe1920.htm#fr_540) Sammata or Sammati
...
