...
which the Castle was situated; but it was so placed that it commanded
the various hills that crowned the ridge. All along the ridge the rock
...
Sir Nathaniel stopped and looked around, as though to lose nothing of
the effect. The sun had climbed the eastern sky and was making all
details clear. He pointed with a sweeping gesture, as though calling
Adam's attention to the extent of the view. Having done so, he covered
the ground more slowly, as though inviting attention to detail. Adam was
a willing and attentive pupil, and followed his motions exactly,
...
to find the RATIONALE of them. Each legend, each superstition which we
...
for the Castle was wisely chosen--on the highest ground. Take the
others. There is something ostensible in each of them, and in all
...
down--that was once the location of a Roman temple, possibly founded on
a pre-existing Druidical one. Its name implies the former, and the grove
of ancient oaks suggests the latter."

"Please explain."

"The old name translated means 'Diana's Grove.' Then the next one higher
than it, but just beyond it, is called 'MERCY'--in all probability a
corruption or familiarisation of the word MERCIA, with a Roman pun
included. We learn from early manuscripts that the place was called
VILULA MISERICORDIAE. It was originally a nunnery, founded by Queen
...
others--in fact, the whole history of early England." Sir Nathaniel,
seeing the expectant look on Adam's face, went on:
...
some sort of structure there when the Romans came, therefore it must
have been a place of importance in Druid times--if indeed that was the
...
Normans--found it a desirable possession and so ensured its upholding.
In the earlier centuries it was merely a vantage ground. But when the
