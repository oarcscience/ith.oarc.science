...
 [Buddhism](../index)   [SBE 11 Index](index)   [Previous](sbe1301) 
 [Next](sbe1303)
...
class="small">1</span></sup>](#page_x_note_1).
...
class="small">2</span></sup>](#page_x_note_2)--and we see no sufficient
...
class="small">3</span></sup>](#page_x_note_3). And the peculiarity which
...
class="small">1</span></sup>](#page_xiii_note_1), where those Bhikkhus
...
class="small">2</span></sup>](#page_xiii_note_2). There may well be some
...
class="small">3</span></sup>](#page_xiii_note_3).
...
class="small">1</span></sup>](#page_xiv_note_1), but sometimes those
...
class="small">2</span></sup>](#page_xiv_note_2). It is perhaps worthy of
...
class="small">1</span></sup>](#page_xv_note_1).
...
class="small">1</span></sup>](#page_xvi_note_1). It should however be
...
class="small">1</span></sup>](#page_xx_note_1) is probably simply due to
...
class="small">1</span></sup>](#page_xxi_note_1) are (as was pointed out
...
class="small">2</span></sup>](#page_xxi_note_2). The first mention of
...
class="small">3</span></sup>](#page_xxi_note_3).
...
class="small">1</span></sup>](#page_xxiii_note_1) We do not enter upon
...
class="small">1</span></sup>](#page_xxiv_note_1).'
...
class="small">1</span></sup>](#page_xxv_note_1).'
...
class="small">1</span></sup>](#page_xxvi_note_1); and the generally
...
class="small">2</span></sup>](#page_xxvi_note_2). Without desiring to
...
class="small">1</span></sup>](#page_xxvii_note_1). He there describes it
...
class="small">2</span></sup>](#page_xxvii_note_2) derived Pâtimokkha
...
class="small">1</span></sup>](#page_xxviii_note_1). Pâtimokkha or
...
class="small">2</span></sup>](#page_xxviii_note_2)
...
class="small">3</span></sup>](#page_xxviii_note_3) in opposition to
...
class="small">1</span></sup>](#page_xxix_note_1).'
...
class="small">2</span></sup>](#page_xxix_note_2)
...
class="small">3</span></sup>](#page_xxix_note_3), and the passage in the
...
class="small">4</span></sup>](#page_xxix_note_4); and in the next
...
class="small">1</span></sup>](#page_xxx_note_1), and in a constantly
recurring verse in the Buddhava*m*sa in which it is opposed to
Vinaya<span id="page_xxx_fr_2"></span>[<sup><span
class="small">2</span></sup>](#page_xxx_note_2), and the word is still
...
class="small">1</span></sup>](#page_xxxi_note_1), and that is in the
appended Khandhakas of the *K*ullavagga, in the account of the Council
of Vesâlî<span id="page_xxxi_fr_2"></span>[<sup><span
class="small">2</span></sup>](#page_xxxi_note_2). Seven passages are
...
class="small">1</span></sup>](#page_xxxii_note_1).'--
...
class="small">2</span></sup>](#page_xxxii_note_2), Upâli might thus
...
class="small">1</span></sup>](#page_xxxiii_note_1).'
...
class="small">2</span></sup>](#page_xxxiii_note_2).
...
class="small">1</span></sup>](#page_xxxiv_note_1).
...
class="small">2</span></sup>](#page_xxxiv_note_2).
...
class="small">3</span></sup>](#page_xxxiv_note_3).'
...
class="small">1</span></sup>](#page_xxxv_note_1).
...
class="small">1</span></sup>](#page_xxxvi_note_1), that we are justified
...
class="small">1</span></sup>](#page_xxxvii_note_1).
...
[Next: Pâtimokkha - Nidâna](sbe1303)
...
<span id="page_x_note_1"></span>[1](#page_x_fr_1) The opening sentence
only is found in the Mahâvagga. See below, [p. xv](#page_xv).

<span id="page_x_note_2"></span>[2](#page_x_fr_2) Mahâvagga II, 1. 1.

<span id="page_x_note_3"></span>[3](#page_x_fr_3) Ibid. II, 4. 2.

<span id="footnotes_page_xiii">p. xiii</span>

<span id="page_xiii_note_1"></span>[1](#page_xiii_fr_1) Phayre MS., vol.
i. fol. kau.

<span id="page_xiii_note_2"></span>[2](#page_xiii_fr_2) *K*ullavagga
XII.

<span id="page_xiii_note_3"></span>[3](#page_xiii_fr_3) In the Ceylon
...
<span id="page_xiv_note_1"></span>[1](#page_xiv_fr_1) For instance,
...
<span id="page_xiv_note_2"></span>[2](#page_xiv_fr_2) For instance,
Pâ*k*ittiya 5, 6, and 43-5; and again, Pâ*k*ittiya 20 and 62, &c.

<span id="footnotes_page_xv">p. xv</span>

<span id="page_xv_note_1"></span>[1](#page_xv_fr_1) With the following
...
<span id="page_xvi_note_1"></span>[1](#page_xvi_fr_1) See, for instance,
...
<span id="page_xviii_note_1"></span>[1](#page_xviii_fr_1) No *k*e Upâli
...
<span id="page_xx_note_1"></span>[1](#page_xx_fr_1) Mr. Dickson has
...
<span id="page_xxi_note_1"></span>[1](#page_xxi_fr_1)
Si<u>n</u>gilo*n*a, dva<u>n</u>gula, &c. (*K*ullavagga XII, 1, 10).

<span id="page_xxi_note_2"></span>[2](#page_xxi_fr_2) That is, as
war-cries; *g*âtarûpara*g*ata occurs in the sense of the precious
metals.

<span id="page_xxi_note_3"></span>[3](#page_xxi_fr_3) In the present
...
<span id="page_xxiii_note_1"></span>[1](#page_xxiii_fr_1) See the
...
<span id="page_xxiv_note_1"></span>[1](#page_xxiv_fr_1)
...
<span id="page_xxv_note_1"></span>[1](#page_xxv_fr_1) Journal of the
Ceylon Asiatic Society, 1867-1870. p. 115.

<span id="footnotes_page_xxvi">p. xxvi</span>

<span id="page_xxvi_note_1"></span>[1](#page_xxvi_fr_1) 'Corpus
Inscriptionum Indicarum,' pl. xv.

<span id="page_xxvi_note_2"></span>[2](#page_xxvi_fr_2) Burnouf
...
<span id="page_xxvii_note_1"></span>[1](#page_xxvii_fr_1) Pâtimokkhan ti
âdi*m* eta*m* mukha*m* eta*m* pamukha*m* eta*m* kusalâna*m* dhammâna*m*,
tena vu*kk*ati pâtimokkhan ti. Mahâvagga II, 3, 4.

<span id="page_xxvii_note_2"></span>[2](#page_xxvii_fr_2) We use the
...
<span id="page_xxviii_note_1"></span>[1](#page_xxviii_fr_1) Compare
Mahâvagga II, 3, 3.

<span id="page_xxviii_note_2"></span>[2](#page_xxviii_fr_2) Yo pana
...
<span id="page_xxviii_note_3"></span>[3](#page_xxviii_fr_3) Though more
...
<span id="page_xxix_note_1"></span>[1](#page_xxix_fr_1) Sutta*m* tassa
âgata*m* na Suttavibha<u>n</u>ga*m*. On the latter term see below.

<span id="page_xxix_note_2"></span>[2](#page_xxix_fr_2) Ubhayâni nu kho
...
<span id="page_xxix_note_3"></span>[3](#page_xxix_fr_3) Compare H.
Oldenberg's Introduction to his edition of the Mahâvagga, pp. 7 and
following.

<span id="page_xxix_note_4"></span>[4](#page_xxix_fr_4) Abhi*ññ*âta*m*
vâ Suttanta*m* bha*n*ati.

<span id="footnotes_page_xxx">p. xxx</span>

<span id="page_xxx_note_1"></span>[1](#page_xxx_fr_1) The
...
<span id="page_xxx_note_2"></span>[2](#page_xxx_fr_2)
...
<span id="page_xxxi_note_1"></span>[1](#page_xxxi_fr_1) That is, of the
Vinaya Pi*t*aka. We are not certain that it may not be found in the
Sutta Pi*t*aka.

<span id="page_xxxi_note_2"></span>[2](#page_xxxi_fr_2) *K*ullavagga
XII, 2, 8.

<span id="footnotes_page_xxxii">p. xxxii</span>

<span id="page_xxxii_note_1"></span>[1](#page_xxxii_fr_1) A*ññ*ataro
...
<span id="page_xxxii_note_2"></span>[2](#page_xxxii_fr_2) Sa*k*e *k*ho
Upâli lekha*m* sikkheyya (Mahâvagga I, 49, 1).

<span id="footnotes_page_xxxiii">p. xxxiii</span>

<span id="page_xxxiii_note_1"></span>[1](#page_xxxiii_fr_1) Lekha*m*
...
<span id="page_xxxiii_note_2"></span>[2](#page_xxxiii_fr_2) Anâpatti
lekha*m* pariyâpu*n*âti (Bhikkhunî-Pâtimokkha. Pâ*k*ittiya 49).

<span id="footnotes_page_xxxiv">p. xxxiv</span>

<span id="page_xxxiv_note_1"></span>[1](#page_xxxiv_fr_1) Mahâvagga II,
17, 5. 6. On this meaning of vitthârena and sa*m*khittena see also
Mahâvagga ll, 15, 1. 2.

<span id="page_xxxiv_note_2"></span>[2](#page_xxxiv_fr_2) Mahâvagga III,
5, 9.

<span id="page_xxxiv_note_3"></span>[3](#page_xxxiv_fr_3)
...
<span id="page_xxxv_note_1"></span>[1](#page_xxxv_fr_1) Compare Burnell,
'Elements of South Indian Palaeography,' p. 10.

<span id="page_xxxv_note_2"></span>[2](#page_xxxv_fr_2) Dîpava*m*sa XX,
...
<span id="page_xxxvi_note_1"></span>[1](#page_xxxvi_fr_1) How little
...
<span id="page_xxxvii_note_1"></span>[1](#page_xxxvii_fr_1) For the
