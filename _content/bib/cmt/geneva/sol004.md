...
\(b\) He has respect for the multitude of the faithful, which are many
in number.
...
\(d\) Come with me from Lebanon, \[my\] spouse, with me from Lebanon:
...
ravished my heart with one of thy (f) eyes, with one chain of thy neck.
...
Spirit on her, which is meant by the North and South wind.
