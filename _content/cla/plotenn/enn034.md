...
[Index](index)  [Previous](enn033)  [Next](enn035) 
...
well-being must be Good in itself quite apart from the perception: to be
...
nobler than one that merely accepts a state: it is a principle of Reason
or of Intellection: pleasure is a state: the reasonless can never be
closer to the Good than reason is. How can reason abdicate and declare
...
different, something of quite another class: Reason cannot be itself one
of those first needs of nature; it cannot even be a cause of those first
needs of nature or at all belong to that order: it must be nobler than
any and all of such things: otherwise it is not easy to see how we can
