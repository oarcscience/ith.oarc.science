...
[Index](index)  [Previous](enn299)  [Next](enn301) 
...
other gods heaped gifts upon her, Hephaistos "blending the clay with
moisture and bestowing the human voice and the form of a goddess";
...
for the rejection of Prometheus' gift by after-thought, Epimetheus, what
can this signify but that the wiser choice is to remain in the
Intellectual realm? Pandora's creator is fettered, to signify that he is
in some sense held by his own creation; such a fettering is external and
the release by Hercules tells that there is power in Prometheus, so that
he need not remain in bonds.
