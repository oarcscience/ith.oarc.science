...
Click to enlarge](img/05802.jpg)  
DIAGRAM No. 3. Showing the Vanishing Point or Horizon of Geolinear
...
The two lines, *a f*, extending the length of [diagram 1](#img_05800),
...
[assumptions](errata.htm#1)upon these appearances, ignoring the facts
and laws of optics. The objects *e d* are in fact at *e d*, as
represented in [diagram 1](#img_05800), but they appear to be at *c*.
...
It will be remembered that [diagram 1](#img_05800) represents the point
...
We subjoin a [second diagram](#img_05801). Here we have two lines as in
[diagram 1](#img_05800), but we will employ them to represent parallel
...
We subjoin the [third diagram](#img_05802). In this we take the lower
line of the [second diagram](#img_05801), A A; we observe the points A A
...
If the line A A in [diagram 3](#img_05802) represented a flat surface, a
...
[Next: An Absolutely Indisputable Premise](cc10)
